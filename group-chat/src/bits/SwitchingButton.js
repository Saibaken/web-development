...
function SwitchingButton() {
  ...
  const iconPressClass = classNames({ "white-fill": clicked === true });
  const buttonClass = classNames("menu-button", {
    "menu-button-chosen": clicked === true,
  });
  const textClass = classNames("menu-item-text", {
    "white-text": clicked === true,
  });
